// AUTO-GENERATED by scripts/migrate.mjs and updated by github-tracker skill.
// Order = sidebar order. Add new categories to scripts/migrate.mjs CATEGORIES array.
export default {
